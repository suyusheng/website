function Location() {
	...
	// '0,1500':{1501:'合肥',1512:'宿州',1522:'淮北',1528:'亳州',1536:'阜阳',1549:'蚌埠',1560:'淮南',1568:'滁州',1581:'马鞍山',1587:'芜湖市',1598:'铜陵',1604:'安庆',1623:'黄山',1635:'六安',1648:'巢湖',1658:'池州',1666:'宣城'},
	...
	// '0,2456':{2457:'武汉',2471:'十堰',2485:'襄樊',2498:'荆门',2506:'孝感',2517:'黄冈',2535:'鄂州',2539:'黄石',2547:'咸宁',2558:'荆州',2570:'宜昌',2589:'随州',2592:'省直辖县级行政单位',2598:'恩施州'},
	...
	// '0,2613':{2614:'长沙',2628:'张家界',2635:'常德',2651:'益阳',2661:'岳阳',2675:'株洲',2689:'湘潭',2696:'衡阳',2714:'郴州',2734:'永州',2755:'邵阳市',2776:'怀化市',2799:'娄底市',2807:'湘西州'},
	...
	// '0,3201':{3202:'海口',3207:'三亚',3208:'省直辖行政单位'},
	...
	// '0,4334':{4335:'兰州',4347:'嘉峪关',4348:'金昌市',4352:'白银',4361:'天水',4374:'武威',4382:'酒泉',4394:'张掖',4406:'庆阳',4422:'平凉',4436:'定西',4450:'陇南',4467:'临夏州',4483:'甘南州'},
	// '0,4334,4335':{4336:'城关区',4337:'七里河区',4338:'西固区',4339:'安宁区',4340:'红古区',4341:'永登县',4342:'城关镇',4343:'皋兰县',4344:'石洞镇',4345:'榆中县',4346:'城关镇'},
	// '0,4334,4347':{4351:'城关镇'},
...
Location.prototype.findName	= function(name) {
	for(var key in this.items){
		for(var j in this.items[key])
		if(this.items[key][j] == name) return j;
	}
}
...
Location.prototype.fillOption	= function(el_id , loc_id , selected_id) {
	var el	= $('#'+el_id);
	var arr = loc_id.split(',') || [];
	if(arr.length==1){
		var id = loc_id;
	}else if(arr.length==2){
		var id = arr[0]+','+this.findName(arr[1]);
	}else if(arr.length == 3){
		var id = arr[0]+','+this.findName(arr[1])+','+this.findName(arr[2]);
	}

	// return;
	var json = this.find(id);
	console.log(json)
	if (json) {
		var index	= 1;
